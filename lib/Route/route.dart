...
import 'package:ayur360_app/Doctor/Patient/appointemntRecordList.dart';
...
import 'package:ayur360_app/Doctor/Patient/appointmentVitalSignScreen.dart';
...
import '../Doctor/Patient/appointmentListEdit.dart';
...
class RoutesName {
  ...
  static const String APPOINTMENT_LISTEDIT = '/appointmentListEdit';
  static const String APPOINTMENT_RECORDSCREEN = '/appointemntRecordList';
  static const String APPOINTMENT_VITALSCREEN = '/appointmentVitalSignScreen';
  static const String APPOINTMENT_CLINICALNOTES =
      '/appointmentClinicalNotesScreen';
  static const String APPOINTMENT_LABTEST = '/appointemntLabTestFirstScreen';
  static const String APOOINTEMENT_PRESCRIPTION =
      '/appointmentPrescriptionScreen';
  static const String APPOINTEMENT_RECCONEXTAPPOINTEMNT =
      '/appointmentReccomendNextAppointment';
  static const String LOST_PASSWORD = '/splashScreen';
}
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case RoutesName.VITALSIGN_LIST:
        List<dynamic>? args = settings.arguments as List?;
        return _GeneratePageRoute(
            widget: vitalsignListScreen(
              vitaldetailsDTO: [args],
            ),
            routeName: settings.name);

      case RoutesName.APPOINTMENT_LISTEDIT:
        List<dynamic>? args = settings.arguments as List?;

        return _GeneratePageRoute(
            widget: AppointemntlistEdit(
              appointemtDetaisID: args?[0] ?? 0,
              dateId: args?[1],
            ),
            routeName: settings.name);

      case RoutesName.APPOINTMENT_RECORDSCREEN:
        Object? args = settings.arguments;
        return _GeneratePageRoute(
            widget: AppointmentRecordScreen(AppointmentIds: args,), routeName: settings.name);
      case RoutesName.APPOINTMENT_VITALSCREEN:
       Object? args = settings.arguments;
        return _GeneratePageRoute(

            widget: AppointmentVitalsignScreen(appointemnentVitalid: args,), routeName: settings.name);
      case RoutesName.APPOINTMENT_CLINICALNOTES:
        Object? args = settings.arguments;
        return _GeneratePageRoute(
            widget: AppointemntclinicalnotesScreen(ClinicalApoointmentId: args,), routeName: settings.name);
      case RoutesName.APPOINTMENT_LABTEST:
        Object? args = settings.arguments;
        return _GeneratePageRoute(
            widget: AppointmentLabtestScreen(LabtestAppointemntid: args,), routeName: settings.name);
      case RoutesName.APOOINTEMENT_PRESCRIPTION:
        return _GeneratePageRoute(
            widget: AppointmentPrescriptionscreen(), routeName: settings.name);
      case RoutesName.APPOINTEMENT_RECCONEXTAPPOINTEMNT:
        Object? args = settings.arguments;
        return _GeneratePageRoute(
            widget: AppointmentReccoNextAppointment(
              date: args.toString(),RecommendAndNextAppoID: args,
            ),
            routeName: settings.name);

      case RoutesName.LOST_PASSWORD:
        return _GeneratePageRoute(
            widget: LostPasswordScreen(), routeName: settings.name);
      default:
        return _GeneratePageRoute(
            widget: WelcomeScreen(), routeName: settings.name);
    }

class prescription {
    ...
    prescription({this.age, this.appointmentDate, this.appointmentId, this.clinicId, this.detailsdtos, this.doctorId, this.doctorName, this.doctorNumber, this.doctorWhatApp, this.gender, this.pageNo, this.patientMail, this.patientName, this.patientNumber, this.patientRegId, this.patientWhatApp, this.prescriptionId, this.qualification, this.rowCount, this.term, this.totalCount, this.userIds});
    ...
    factory prescription.fromJson(Map<String, dynamic> json) {
        return prescription(
            ...
            detailsdtos: json['detailsdtos'] != null ? (json['detailsdtos'] as List).map((i) => Detailsdto.fromJson(i)).toList() : null,
...
class Detailsdto {
    ...
    Detailsdto({this.categoryName, this.doctorSuggestion, this.drugId, this.drugName, this.drugStrength, this.duration, this.durationType, this.foodStatus, this.image, this.labTestId, this.morningCount, this.nightCount, this.noonCount, this.notes});

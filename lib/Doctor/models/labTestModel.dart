class Labtest {
    ...
    Labtest({this.age, this.appointmentDate, this.appointmentId, this.clinicId, this.detailsdto, this.doctorId, this.doctorMail, this.doctorName, this.doctorNumber, this.doctorWhatApp, this.gender, this.labId, this.labTest, this.pageNo, this.patientId, this.patientMail, this.patientName, this.patientNumber, this.patientRegId, this.patientWhatApp, this.qualification, this.rowCount, this.totalCount, this.userIds});
...
class Detailsdto {
    ...
    Detailsdto({this.labTest, this.labTestId, this.otherTest});

class ClinicalTestModel {
    ...
    ClinicalTestModel({this.age, this.appointmentDate, this.appointmentId, this.clinicId, this.clinicalNotesId, this.detailsdto, this.doctorId, this.doctorMail, this.doctorName, this.doctorNumber, this.doctorWhatApp, this.gender, this.pageNo, this.patientId, this.patientMail, this.patientName, this.patientNumber, this.patientRegId, this.patientWhatApp, this.qualification, this.rowCount, this.totalCount, this.userIds});
    ...
    factory ClinicalTestModel.fromJson(Map<String, dynamic> json) {
        return ClinicalTestModel(
            ...
            detailsdto: json['detailsdto'] != null ? (json['detailsdto'] as List).map((i) => Detailsdto.fromJson(i)).toList() : null,
...
class Detailsdto {
    ...
    Detailsdto({this.clinicId, this.clinicalNotes, this.clinicalNotesId, this.clinicalType, this.complaints, this.diagnosis});

...
class ClinicalTestListBloc {
  ClinicalTestRepository _clinicaltestListRepository= new ClinicalTestRepository();
  final _clinicalTestListDataController= StreamController<Response<List<ClinicalTestModel>>>();
  ...
  getclinalList() async {
    ...
    try {
      List<ClinicalTestModel> _PrescriptionList = await _clinicaltestListRepository.getClinicalTest();

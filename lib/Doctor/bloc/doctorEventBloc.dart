...
class DoctorEventListBloc {
  DoctorEventRepository _doctorEventListRepository= new DoctorEventRepository();
  final _doctorEvntListDataController= StreamController<Response<List<doctorEventmodel>>>();
  ...
  getdoctoreventLists() async {
    ...
    try {
      List<doctorEventmodel> _doctorEVENTList = await _doctorEventListRepository.getDoctoreventList();

...
class PrescriptionListBloc {
  PrescriptionRepository _prescriptionListRepository= new PrescriptionRepository();
  final _prescriptionListDataController= StreamController<Response<List<prescription>>>();
  ...
  getprescriptionList() async {
    ...
    try {
      List<prescription> _PrescriptionList = await _prescriptionListRepository.getprescription();

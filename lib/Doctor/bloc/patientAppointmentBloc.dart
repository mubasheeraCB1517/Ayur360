...
class PatientAppointmentListBloc {
  PatientAppointmentListRepository _patientAppointemntListRepository =
      new PatientAppointmentListRepository();
  final _patientAppointmentListDataController =
      StreamController<Response<List<patientappointment>>>();

  StreamSink<Response<List<patientappointment>>>
      get patientAppointmentListDataSink =>
          _patientAppointmentListDataController.sink;

  Stream<Response<List<patientappointment>>>?
      get patientAppointmentListDataStream =>
  ...
  getAppointmentLists() async {
    ...
    try {
      List<patientappointment> _patientAppointmentList =
          await _patientAppointemntListRepository.getpatientAppointmentList();
      patientAppointmentListDataSink
          .add(Response.success(_patientAppointmentList));
    } catch (e) {

...
class MyAppointmentListBloc {
  MyAppointmentListRepository _myAppointemntListRepository =
      new MyAppointmentListRepository();
  final _myAppointmentListDataController =
      StreamController<Response<List<myAppointment>>>();
  ...
  getAppointmentLists() async {
    ...
    try {
      List<myAppointment> _myAppointmentList =
          await _myAppointemntListRepository.getAppointmentList();

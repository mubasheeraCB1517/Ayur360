...
class DeviceInfo {
  ...
  String? get deviceName =>
      Platform.isAndroid ? _androidDeviceInfo.model : _iosDeviceInfo.name;

  String? get deviceVersion => Platform.isAndroid
      ? _androidDeviceInfo.version.toString()
      : _iosDeviceInfo.systemVersion;

  String? get identifier => Platform.isAndroid
      ? _androidDeviceInfo.androidId
      : _iosDeviceInfo.identifierForVendor;

  String? get deviceBrand =>
      Platform.isAndroid ? _androidDeviceInfo.brand : _iosDeviceInfo.model;

  String? get deviceManufaturer => Platform.isAndroid
      ? _androidDeviceInfo.manufacturer
      : _iosDeviceInfo.systemName;

  String? get isPhysicalDevice => Platform.isAndroid
      ? _androidDeviceInfo.isPhysicalDevice.toString()
      : _iosDeviceInfo.isPhysicalDevice.toString();
}

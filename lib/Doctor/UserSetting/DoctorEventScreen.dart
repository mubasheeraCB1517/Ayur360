...
import 'package:ayur360_app/Doctor/bottomsheetcreate.dart';
import 'package:ayur360_app/Doctor/bottomsheetedit.dart';
import 'package:ayur360_app/Doctor/models/prescriptionModel.dart';
import 'package:ayur360_app/Doctor/repositories/leaveReportDelete.dart';
...
class _DoctorEventState extends State<DoctorEvent> {
  ...
  LeaveReportDeleteRepository leavereportdelete = LeaveReportDeleteRepository();
  ...
  void showBottomSheetedit(context, int eventid) {
    showModalBottomSheet(
        context: context,
        isScrollControlled: true,
        backgroundColor: Colors.transparent,
  ...
  showAlertDialog(BuildContext context, eventid1) {
    // set up the button
    Widget okButton = TextButton(
      ...
      onPressed: () {
        leavereportdelete.getLeaveReportdelete(eventid1);
  ...
  ListView _jobsListView(data) {
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          print("eventId->>>>>>${data[index].eventsId}");
          return _tile(
  ...
  _tile(String doctorName, String eventsName, String eventsDate, String fullDay,
          String timeDurationFrom, String timeDurationTo, int EventId) =>
      Card(
        ...
        child: ListTile(
            title: Row(
              children: [
                ...
                GestureDetector(
                    onTap: () {
                      showBottomSheetedit(context, EventId);
                    },
                    child: Icon(
                      Icons.edit,
                      color: Colors.blue,
                ...
                GestureDetector(
                    onTap: () {
                      showAlertDialog(context, EventId);
                      //
                    },
                    child: Icon(
                      Icons.delete,

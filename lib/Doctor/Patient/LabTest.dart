...
class _LabTestScreenState extends State<LabTestScreen> {
  ...
  SizedBox _tile(String title, String subtitle, String subtitle1,
          String subtitle2, labtestDetailsDto) =>
      SizedBox(
        height: 150,
        child: Card(
          ...
          child: ListTile(
              ...
              onTap: () {
                WidgetsBinding.instance!.addPostFrameCallback((_) {
                  Navigator.pushNamed(context, RoutesName.LAB_TESTLIST,
                      arguments: labtestDetailsDto);
                });
              }),
        ),
      );
